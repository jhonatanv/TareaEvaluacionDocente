...
@Entity
@NamedQueries({ @NamedQuery(name = Acceso.LISTAR_ACCSESOS_POR_ROL, query = "SELECT acc FROM AccesoRol acrol JOIN acrol.rol ro JOIN acrol.acceso acc WHERE acrol.rol IN ?1") })
